...
assert.equal(pkg.edition3.buildVersion, release.buildVersion); assert.equal(release.schemaVersion, 55); assert.equal(pkg.edition3.schemaVersion, release.schemaVersion); assert.equal(release.apiVersion, 1);
