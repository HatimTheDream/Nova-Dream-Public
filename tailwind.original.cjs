...
module.exports = {
  content: [require('node:path').join(__dirname, 'apps/client/src/dreamclaw/**/*.{ts,tsx}')],
  important: '.dreamclaw-module',
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['Nunito Sans Variable', 'Noto Sans Arabic Variable', 'Noto Sans', 'Yu Gothic UI', 'Microsoft YaHei UI', 'system-ui', 'sans-serif'],
        mono: ['JetBrains Mono', 'SF Mono', 'Fira Code', 'Consolas', 'monospace'],
        arabic: ['Noto Sans Arabic Variable', 'Nunito Sans Variable', 'Segoe UI', 'Tahoma', 'sans-serif'],
      },
      boxShadow: {
