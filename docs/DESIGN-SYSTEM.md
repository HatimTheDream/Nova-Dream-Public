...
Living visual and interaction reference · baseline: application 1.8.4 · updated 21 September 2026.
...
**Rail sizing:** desktop brand and module buttons retain their consistent **60 × 60 CSS px** scale. At phone widths, navigation starts closed and opens as a named drawer with readable labels and targets at least 48 px high, leaving the workspace its full width. This supersedes the earlier always-visible narrow rail. Apple's archived [QA1686](https://developer.apple.com/library/archive/qa/qa1686/_index.html) lists 120 × 120 px at 2× and 180 × 180 px at 3× for the 60-point Home Screen icon that informed the desktop scale. CSS pixels do not establish identical physical dimensions on every device. Keep Settings reachable and return keyboard focus to the navigation toggle when the drawer closes.
